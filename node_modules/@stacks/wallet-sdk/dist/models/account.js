...
function getStxAddress(accountOrOptions, network = 'mainnet') {
    if ('account' in accountOrOptions) {
        ...
        return (0, transactions_1.getAddressFromPrivateKey)(account.stxPrivateKey, network);
    }
    return (0, transactions_1.getAddressFromPrivateKey)(accountOrOptions.stxPrivateKey, network);
}
...
const getAppPrivateKey = ({ account, appDomain, }) => {
    ...
    const appKeychain = appsNode.deriveChild(appIndex + common_3.HARDENED_OFFSET);
...
const makeAuthResponse = async ({ account, appDomain, transitPublicKey, scopes = [], gaiaHubUrl, appPrivateKeyFromWalletSalt = null, additionalData = {}, fetchFn = (0, common_2.createFetchFn)(), }) => {
